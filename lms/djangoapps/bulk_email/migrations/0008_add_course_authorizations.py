...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'CourseAuthorization', fields ['course_id', 'email_enabled']
        db.create_unique('bulk_email_courseauthorization', ['course_id', 'email_enabled'])


    def backwards(self, orm):
        # Removing unique constraint on 'CourseAuthorization', fields ['course_id', 'email_enabled']
        db.delete_unique('bulk_email_courseauthorization', ['course_id', 'email_enabled'])
    ...
    models = {
        ...
        'bulk_email.courseauthorization': {
            'Meta': {'unique_together': "(('course_id', 'email_enabled'),)", 'object_name': 'CourseAuthorization'},
